...
class ProductDetailComponent {
    constructor(productService, route, cart) {
...
ProductDetailComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ProductDetailComponent, selectors: [["app-product-detail"]], decls: 20, vars: 5, consts: [[1, "container", "product-details"], [1, "image"], [3, "src"], [1, "details"], [1, "category"], [1, "title"], [1, "description"], [1, "color"], [1, "shopping-details"], [1, "price-per-unit"], [1, "price"], [1, "buy-button"], [1, "cart", 3, "click"], ["aria-hidden", "true", 1, "fa", "fa-shopping-cart"]], template: function ProductDetailComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProductDetailComponent_Template_div_click_18_listener() { return ctx.addToCart(ctx.productItem); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ProductDetailComponent, [{
    ...
    }], function () { return [{ type: _service_data_service__WEBPACK_IMPORTED_MODULE_1__["DataService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }, { type: _service_cart_service__WEBPACK_IMPORTED_MODULE_3__["CartService"] }]; }, null); })();
...
/* harmony import */ var _product_detail_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./product-detail-routing.module */ "./src/app/product-detail/product-detail-routing.module.ts");
/* harmony import */ var _product_detail_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./product-detail.component */ "./src/app/product-detail/product-detail.component.ts");
